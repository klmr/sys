...
test_env$.sys = list(script_name = 'test',
                     exit = function (code, msg) msg)
...
test('-v3', list(opt('v', '', 'level of verbose logging', c(verbose = ''),
                     validation = function (value) value %in% c('', 'v', 'vv'))))
```
...
test('-vvv', list(opt('v', '', 'level of verbose logging', c(verbose = ''),
                      validation = function (value) value %in% c('', 'v', 'vv'),
                      action = function (value) nchar(value) + 1)),
     list(verbose = 3))
